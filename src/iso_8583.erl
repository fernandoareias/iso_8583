...
%% Exported Functions
%%
-export([new/0, set/3, set_mti/2, get/2, get/3, get_mti/1, get_fields/1, has_field/2,
         remove/2, set_attribute/3, get_attribute/2, get_attribute/3, get_attribute_keys/1,
         remove_attribute/2, is_message/1]).
...
-spec set(FieldId :: integer() | [integer()], iso8583field_value(), iso8583message()) ->
             iso8583message().
...
set(FieldId, FieldValue, #iso8583_message{values = Dict} = Message)
    when is_integer(FieldId) andalso FieldId >= 0 ->
...
-spec get(FieldId :: integer() | [integer()], iso8583message()) -> iso8583field_value().
...
-spec has_field(FieldId :: integer() | [integer()], iso8583message()) -> boolean().
...
-spec get_fields(iso8583message()) -> [integer()].
...
-spec get_attribute_keys(iso8583message()) -> [any()].
...
-spec remove(FieldId :: integer() | [integer()], iso8583message()) -> iso8583message().
