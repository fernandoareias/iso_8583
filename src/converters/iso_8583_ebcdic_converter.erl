...
ascii_to_ebcdic_char(H) when H >= $S andalso H =< $Z ->
    H - $S + 226;
ascii_to_ebcdic_char($ ) -> 64;
ascii_to_ebcdic_char($.) -> 75;
ascii_to_ebcdic_char($<) -> 76;
ascii_to_ebcdic_char($() -> 77;
ascii_to_ebcdic_char($+) -> 78;
ascii_to_ebcdic_char($|) -> 79;
ascii_to_ebcdic_char($&) -> 80;
ascii_to_ebcdic_char($!) -> 90;
ascii_to_ebcdic_char($$) -> 91;
ascii_to_ebcdic_char($*) -> 92;
ascii_to_ebcdic_char($)) -> 93;
ascii_to_ebcdic_char($;) -> 94;
ascii_to_ebcdic_char($-) -> 96;
ascii_to_ebcdic_char($/) -> 97;
ascii_to_ebcdic_char($,) -> 107;
ascii_to_ebcdic_char($%) -> 108;
ascii_to_ebcdic_char($_) -> 109;
ascii_to_ebcdic_char($>) -> 110;
ascii_to_ebcdic_char($?) -> 111;
ascii_to_ebcdic_char($`) -> 121;
ascii_to_ebcdic_char($:) -> 122;
ascii_to_ebcdic_char($#) -> 123;
ascii_to_ebcdic_char($@) -> 124;
ascii_to_ebcdic_char($') -> 125;
ascii_to_ebcdic_char($=) -> 126;
ascii_to_ebcdic_char($") -> 127;
ascii_to_ebcdic_char($~) -> 161;
ascii_to_ebcdic_char($^) -> 176;
ascii_to_ebcdic_char($[) -> 186;
ascii_to_ebcdic_char($]) -> 187;
ascii_to_ebcdic_char(${) -> 192;
ascii_to_ebcdic_char($}) -> 208;
ascii_to_ebcdic_char($\\) -> 224.
