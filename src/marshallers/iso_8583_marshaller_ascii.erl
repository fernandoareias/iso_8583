...
marshal_bitmap(Message) ->
	...
	{iso_8583_converters:binary_to_ascii_hex(iso_8583_converters:list_to_bitmap(Fields, 0)), UpdatedMessage}.
...
unmarshal_bitmap(AsciiMessage) ->
	...
	Bitmap = iso_8583_converters:ascii_hex_to_binary(erlang:binary_to_list(AsciiBitmap)),
