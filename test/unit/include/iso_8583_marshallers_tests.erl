...
marshaller_ascii_test_() ->
    [
     ...
     ?_assertEqual(iso_8583_marshaller_ascii, proplists:get_value(field_marshaller, ?MARSHALLER_ASCII)),
     ?_assertEqual(iso_8583_marshaller_ascii, proplists:get_value(bitmap_marshaller, ?MARSHALLER_ASCII)),
     ?_assertEqual(iso_8583_marshaller_ascii, proplists:get_value(mti_marshaller, ?MARSHALLER_ASCII)),
     ?_assertEqual(iso_8583_marshaller_ascii, proplists:get_value(end_marshaller, ?MARSHALLER_ASCII))
    ].
...
marshaller_binary_test_() ->
    [
     ...
     ?_assertEqual(iso_8583_marshaller_binary, proplists:get_value(field_marshaller, ?MARSHALLER_BINARY)),
     ?_assertEqual(iso_8583_marshaller_binary, proplists:get_value(bitmap_marshaller, ?MARSHALLER_BINARY)),
     ?_assertEqual(iso_8583_marshaller_binary, proplists:get_value(mti_marshaller, ?MARSHALLER_BINARY)),
     ?_assertEqual(iso_8583_marshaller_binary, proplists:get_value(end_marshaller, ?MARSHALLER_BINARY))
    ].
...
marshaller_ebcdic_test_() ->
    [
     ...
     ?_assertEqual(iso_8583_marshaller_ebcdic, proplists:get_value(field_marshaller, ?MARSHALLER_EBCDIC)),
     ?_assertEqual(iso_8583_marshaller_ebcdic, proplists:get_value(bitmap_marshaller, ?MARSHALLER_EBCDIC)),
     ?_assertEqual(iso_8583_marshaller_ebcdic, proplists:get_value(mti_marshaller, ?MARSHALLER_EBCDIC)),
     ?_assertEqual(iso_8583_marshaller_ebcdic, proplists:get_value(end_marshaller, ?MARSHALLER_EBCDIC))
    ].
...
marshaller_json_test_() ->
    [
     ...
     ?_assertEqual(iso_8583_marshaller_json, proplists:get_value(field_marshaller, ?MARSHALLER_JSON)),
     ?_assertEqual(iso_8583_marshaller_json, proplists:get_value(bitmap_marshaller, ?MARSHALLER_JSON)),
     ?_assertEqual(iso_8583_marshaller_json, proplists:get_value(mti_marshaller, ?MARSHALLER_JSON)),
     ?_assertEqual(iso_8583_marshaller_json, proplists:get_value(init_marshaller, ?MARSHALLER_JSON)),
     ?_assertEqual(iso_8583_marshaller_json, proplists:get_value(end_marshaller, ?MARSHALLER_JSON))
    ].
...
marshaller_xml_test_() ->
    [
     ...
     ?_assertEqual(iso_8583_marshaller_xml, proplists:get_value(field_marshaller, ?MARSHALLER_XML)),
     ?_assertEqual(iso_8583_marshaller_xml, proplists:get_value(bitmap_marshaller, ?MARSHALLER_XML)),
     ?_assertEqual(iso_8583_marshaller_xml, proplists:get_value(mti_marshaller, ?MARSHALLER_XML)),
     ?_assertEqual(iso_8583_marshaller_xml, proplists:get_value(init_marshaller, ?MARSHALLER_XML)),
     ?_assertEqual(iso_8583_marshaller_xml, proplists:get_value(end_marshaller, ?MARSHALLER_XML))
    ].
...
marshaller_grpc_test_() ->
    [
     ...
     ?_assertEqual(iso_8583_marshaller_grpc, proplists:get_value(field_marshaller, ?MARSHALLER_GRPC)),
     ?_assertEqual(iso_8583_marshaller_grpc, proplists:get_value(bitmap_marshaller, ?MARSHALLER_GRPC)),
     ?_assertEqual(iso_8583_marshaller_grpc, proplists:get_value(mti_marshaller, ?MARSHALLER_GRPC)),
     ?_assertEqual(iso_8583_marshaller_grpc, proplists:get_value(message_marshaller, ?MARSHALLER_GRPC))
    ].
...
marshaller_keys_are_atoms_test_() ->
    CheckKeys = fun(Marshaller) ->
        lists:all(fun({K, _V}) -> is_atom(K) end, Marshaller)
    end,
    [
...
marshaller_values_are_atoms_test_() ->
    CheckValues = fun(Marshaller) ->
        lists:all(fun({_K, V}) -> is_atom(V) end, Marshaller)
    end,
    [
